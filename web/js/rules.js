document.addEventListener('DOMContentLoaded', function() {
    ...
    function createCondition() {
        ...
        addButton.addEventListener('click', createCondition);

        const removeButton = document.createElement('button');
        removeButton.type = 'button';
        removeButton.classList.add('btn', 'btn-danger', 'btn-sm', 'btn-m');
        removeButton.setAttribute("data-default-rule", false);
    ...
    const addButtons = document.querySelectorAll('.add-condition-button');
    addButtons.forEach(button => {
       button.addEventListener('click', createCondition);
    });
